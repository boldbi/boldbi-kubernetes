...
1. Download the following files for Bold BI deployment in Amazon EKS:
    ...
    * [db-server-secret.yaml](https://raw.githubusercontent.com/boldbi/boldbi-kubernetes/v6.1.8/deploy/db-server-secret.yaml)
    * [license-key-secret.yaml](https://raw.githubusercontent.com/boldbi/boldbi-kubernetes/v6.1.8/deploy/license-key-secret.yaml)
    ...
    * [pvclaim_eks.yaml](https://raw.githubusercontent.com/boldbi/boldbi-kubernetes/v6.1.8/deploy/pvclaim_eks.yaml)
