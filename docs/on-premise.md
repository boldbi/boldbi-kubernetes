...
14. By default all the client libraries will be installed in the Bold BI in Kubernetes and also you can still overwrite them mentioning the required libraries as comma seperated in the Environment variable noted from the above link.
