...
boldbi/boldbi   7.1.16           7.1.16         Embed powerful analytics inside your apps and t...
```
...
```console
helm install [RELEASE_NAME] boldbi/boldbi -f [Crafted values.yaml file] -n [Namespace]  --version 5.4.202
```
Ex:  `helm install boldbi boldbi/boldbi -f my-values.yaml -n bold-services  --version 5.4.202`
