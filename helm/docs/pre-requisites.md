...
Currently we have provided support for `Nginx`, `Istio`, `Kong` and `Traefik` as Load Balancers in Bold BI. By default Nginx is used as reverse proxy for Bold BI.
