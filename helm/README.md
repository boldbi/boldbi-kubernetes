...
* For `EKS` please download the values.yaml file [here](https://raw.githubusercontent.com/boldbi/boldbi-kubernetes/blob/KC269938/helm/custom-values/eks-values.yaml).
