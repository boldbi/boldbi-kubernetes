...
You can download the upgrade script from this [link](https://raw.githubusercontent.com/boldbi/boldbi-kubernetes/v7.2.8/upgrade/upgrade.sh) or use the below command.
...
```sh
./upgrade.sh --version="7.2.8" --namespace="bold-services"
```
